...
FONEPAY_RETURN_URL = config('FONEPAY_RETURN_URL')
...
LOGGING = {
    ...
    'handlers': {
        'file': {
            ...
            'filename': os.path.join(LOGS_DIR, 'django.log'),  # Use LOGS_DIR
            'formatter': 'verbose',
        },
        'console': {
            'level': 'INFO',
...
PASSWORD_HASHERS = [
    'django.contrib.auth.hashers.Argon2PasswordHasher',  # Strongest password hashing algorithm
]
